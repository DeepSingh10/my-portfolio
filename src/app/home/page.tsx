                ...
                <div className='flex justify-center p-8'>
                    <div className='flex flex-col gap-8 justify-center items-center w-full'>
                        <div className='flex flex-col items-start gap-1.5'>
                            ...
                            <h1 className='text-white font-semibold text-5xl'>Deep Singh Yadav</h1>
                            <h2 className='text-3xl flex justify-center items-center text-[#615FFF]'> <LuChevronRight /> Full-stack developer </h2>
                        </div>
                        <div>
                            ...
                            <div className='flex gap-1.5'>
                                ...
                                <Link className='text-[#e99287]' href={"https://github.com/DeepSingh10"}>"https://github.com/DeepSingh10"</Link>
                            </div>
                        </div>
                    </div>

                    <div className='flex flex-col gap-4 justify-center items-center w-full'>
                        <Image className='z-10 opacity-40' src={"/code-snippet.png"} height={183} width={560} alt='code-snippet' />
                        <Image className='z-10' src={"/code-snippet.png"} height={183} width={560} alt='code-snippet' />
                        <Image className='z-10 opacity-40' src={"/code-snippet.png"} height={183} width={560} alt='code-snippet' />
                    </div>
                </div>
                <Footer />
